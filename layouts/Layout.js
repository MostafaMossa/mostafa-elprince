...
const LayoutPc = ({ children }) => {
    return (
        <>
            ...
            {/* Mobile view */}
            <div className="grid place-items-center h-full w-full lg:hidden">
                <HeaderMenu />
            ...
            {/* Pc view */}
            <div className="hidden  lg:flex place-items-center h-[85vh] md:h-[95vh] lg:h-[100vh] w-[100vw] p-0 md:p-2 lg:p-4">
                <div className="flex-1 bg-gray-800 h-[90%] lg:h-full rounded-3xl shadow-2xl shadow-black p-0 md:p-1 lg:p-3 mx-1 md:mx-2 lg:mx-4">
                    <div className="grid place-items-center h-[85%] md:h-[95%] lg:h-full text-gray-50 overflow-y-auto">
                        {children}
                    </div>
                </div>
